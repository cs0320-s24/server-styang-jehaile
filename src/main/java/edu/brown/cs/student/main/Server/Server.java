...
/**
 * Top-level class which contains the main() method which starts Spark and runs the various handlers
...
public class Server {
   ...
   * the same shared state which is the data source class. Meanwhile, the broadband class takes in
   * the class which handles caching which takes in the broadband data source. This main method
  ...
  public static void main(String[] args)
    ...
    Spark.get(
        "broadband",
        new BroadbandHandler(new CachingBroadbandDataSource(new BroadbandDataSource())));
    Spark.init();
